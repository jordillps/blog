...
class RolesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.index')->withFlash('El rol se creó correctamente');
     ...
     */
     public function destroy(Role $role)
     {
        ...
        return redirect()->route('admin.roles.index')->withFlash('Rol eliminado correctamente');
